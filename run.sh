...
# #ImageNet-LT (SGD)
python3 imnet_train.py --imb_type exp --imb_factor 0.01 --data_path /mnt/disks/persist/imagenet --loss_type CE --train_rule None --dataset imagenet -b 128 --epochs 90 --arch resnet50 --cos_lr --lr 0.2 --distributed
