...
# python hessian_analysis.py --exp_str sample --resume checkpoint/imagenet_resnet50_CE_DRW_exp_0.01_0/ckpt.best.pth.tar --loss_type CE --dataloader_hess  --train_rule DRW
# #ImageNet-LT (SAM)
